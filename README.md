...
- 扩展全武将人物档案，加入独立生平、内政技能、军事技能和程序化写实头像。
- 让武将技能进入实际公式：开发、征税、征兵、招揽、AI 行动、叛乱压力和战斗选将都会读取相关技能或职责。
- 调整数值模型：征税增加税负和流民，征兵按人口转兵力结算，月度人口增长放缓。
- 更新开发守则，加入“编码前思考、简洁优先、精准修改、目标驱动验证”的项目化规则。
